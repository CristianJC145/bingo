...
const WinnerModal:React.FC<WinnerModalProps> = ({ winnerCards, isOpen, onClose }) => {
            ...
            <div className="winner-overlay">
                <div className="winner-modal">
                    <div className="img-winner">
                        ...
                        <h3 className="winner-list">{ winnerCards[0] < 100 ? `000${winnerCards[0]}` : winnerCards[0] }</h3>
                    </div>
                    <AppButton onClick={onClose} variant="light" outlined icon="times"></AppButton>
                </div>
            </div>
        </WinnerModalStyle>
    )
